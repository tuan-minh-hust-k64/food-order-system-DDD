...
import com.food.ordering.system.restaurant.service.domain.ports.output.message.publish.RestaurantRejectedMessagePublisher;
...
@Slf4j
@Component
public class OrderRejectedKafkaMessagePublisher implements RestaurantRejectedMessagePublisher {

    private final RestaurantMessagingDataMapper restaurantMessagingDataMapper;
    private final KafkaProducer<String, RestaurantApprovalResponseAvroModel> kafkaProducer;
    private final RestaurantDataConfig restaurantServiceConfigData;
    ...
    public OrderRejectedKafkaMessagePublisher(RestaurantMessagingDataMapper restaurantMessagingDataMapper,
                                              ...
                                              RestaurantDataConfig restaurantServiceConfigData,
